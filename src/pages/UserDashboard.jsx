      ...
      <div className="card-row">
        <div className="card shadow-sm mb-4"> 
          <div className="card-body">
            ...
            <a href="/user/account" className="btn btn-primary mt-3">View Account</a>
          </div>
        </div>
        ...
        <div className="card shadow-sm mb-4"> 
          <div className="card-body">
            ...
            <a href="/user/payments" className="btn btn-secondary mt-3">View Payments</a>
          </div>
        </div>
        ...
        <div className="card shadow-sm mb-4"> 
          <div className="card-body">
            ...
            <a href="/user/support" className="btn btn-danger">Contact Support</a>
          </div>
        </div>
      </div>
    </div>
